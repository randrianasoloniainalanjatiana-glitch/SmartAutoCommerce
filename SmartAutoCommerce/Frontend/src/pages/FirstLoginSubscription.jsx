...
const API_BASE_URL = DJANGO_API; // Assuming the backend is running here

const FirstLoginSubscription = () => {
    ...
    return (
        <div className="min-h-screen w-full bg-gray-50 dark:bg-gray-950 text-gray-900 dark:text-gray-100 flex items-center justify-center p-6 relative">
            <div className="max-w-4xl w-full bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 rounded-2xl p-8 shadow-2xl relative overflow-hidden">
                {/* Decorative blobs */}
...
export default FirstLoginSubscription;
